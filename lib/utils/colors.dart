...
class AppColors {
  ...
  static const Color primaryDark =
      Color(0xFF0056B3); // Darker Blue - Hover/Pressed State
  static const Color secondary =
      Color(0xFF17A2B8); // Teal - Secondary Highlights

  // Background & Surface
  static const Color background =
      Color(0xFFF8F9FA); // Light Gray - App Background
  static const Color surface =
      Color(0xFFFFFFFF); // White - Cards, Modals, Forms
  static const Color divider =
      Color(0xFFCED4DA); // Light Gray - Dividers & Borders

  // Text Colors
  static const Color textPrimary =
      Color(0xFF212529); // Dark Gray - Primary Text
  static const Color textSecondary =
      Color(0xFF6B7378); // Medium Gray - Secondary Text
  ...
  static const Color warning =
      Color(0xFFFFC107); // Yellow - Warnings & Low Stock Alerts
  static const Color error =
      Color(0xFFDC3545); // Red - Errors & Critical Alerts
  ...
  static const Color card = Color(0xFFF3EEEE);
}
